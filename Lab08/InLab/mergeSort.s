...
; Spring 2021
; mergeSort.s	
; *Note: This is for macOS. For linux compilation, the _ before mergeSort and merge needs to be removed
...
_mergeSort:
	...
	cmp	rdx, rsi	;right <= left?
	jle	done		;if so, done
	xor	r10, r10	;zero out mid
	add	r10, rsi	;mid = left + right
	add	r10, rdx	;
	xor	r11, r11	;r11 = 2
	inc	r11		;
	inc	r11		;
	...
	div	r11		;rax /= 2
	pop	rdx
	mov	r10, rax	;now, mid = (left + right) / 2
	pop	rax
	push	rdx
	mov	rdx, r10	;rdx now stores mid
	push	r10
	call	_mergeSort	;mergeSort(arrayptr, left, mid)
	pop	r10
	pop	rdx		;restore rdx
	...
	push	rdx
	mov	rdx, r10	;rdx = mid
	push	r10		;save r10 and r11
	push	r11
	call	_merge		;merge(A, left, mid, right)
