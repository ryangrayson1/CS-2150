...
private:
   ...
   void insert(const string& x, AVLNode*& a);
  
  bool find(const string& x, AVLNode* a) const;

  int numNodes(AVLNode* a) const;

  string pathTo(const string& x, AVLNode* a, string& path) const;
};
