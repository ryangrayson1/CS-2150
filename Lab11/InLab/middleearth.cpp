 ...
 *
 * @param first A vector iterator representing the first position in the vector
 * @param last A vector iterator representing the last position in the vector
 * @param g A Mersenne Twister engine object passed by reference
 *
 * This function shuffles a vector of strings by iterating through the vector 
 * and performing swaps
 */
 ...
 *
 * The parameterized Middle earth constructor; initializes variables 
 * accordingly and sets up random number generator
 *
 * @param xsize The size of the x axis of the world
 * @param ysize The size of the y axis of the world
...
/**
 * @brief Method to print the cities and distances
 *
 ...
 *
 * @param city1 The string representation of the first city
 * @param city2 The string representation of the second city
 *
...
/**
 * @brief finds a list of cities to travel to
 *
 ...
 *
 * @param length the number of cities the user requests to visit
 *
 * @return the list of cities(represented as strings) in the itinerary
 */
